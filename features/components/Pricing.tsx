    ...
    >
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          ...
          <p className="text-gray-400 base text-xl sm:text-lg max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6">
          {plans.map((plan, key) => (
            <div
              key={key}
              className={`relative bg-slate-950/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full 
              ${
                plan.mostPopular
            ...
            >
              ...
              {plan.mostPopular && (
                <div className="absolut -top-2 sm:-top-3 left-1/2 transform -translate z-10">
                  <div className="flex items-center space-x-1 px-3 sm:px-4 sm:py-1.5 bg-gradient-to-b from-blue-500 to-cyan-500 rounded-full text-xs sm:text-sm font-semibold shadow-lg">
              ...
              <div className="text-center mb-6 sm:mb-8">
                ...
                <div className="flex items-baseline justify-center">
                  ...
                  <span className="text-gray-400 ml-1 sm:ml-2 text-sm sm:base">
                    /month
                  </span>
                </div>
              </div>
        ...
        <div className="mt-8 sm:mt-12 text-center">
          <p className="text-gray-400 base text-xl">
            Need a custom plan?{" "}
